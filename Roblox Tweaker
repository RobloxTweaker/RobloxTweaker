if IY_LOADED and not _G.IY_DEBUG == true then
	error("Roblox Tweaker is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Roblox Tweaker is waiting for the game to load!'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Roblox Tweaker FE"..ver
